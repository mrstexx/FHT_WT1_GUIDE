$('#nameSearch').on('click', function () {
    ...
    $('#raumbelegung-structure').prepend('<input type="text" id="searchbar" class="mx-auto" placeholder="Enter roomname"> <button class="search-button"><i class="fa fa-search"></i></button>');
});
